...
namespace Maven.Repositories
{
    public class VersionedClassifiersRepository : InMemoryRepository<VersionedClassifierEntity>, IVersionedClassifiersRepository
    {
        ...
        public VersionedClassifierEntity GetSingleClassifierData(Guid repoId, string[] group, string artifactId, string version, bool isSnapshot, string classifier,string build, ITransaction transaction = null)
        {
        ...
        public IEnumerable<VersionedClassifierEntity> GetAllClassifiersData(Guid repoId, string[] group, string artifactId, string version, bool isSnapshot, string build,ITransaction transaction = null)
        {
